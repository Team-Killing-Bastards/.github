...
<img src="https://raw.githubusercontent.com/Team-Killing-Bastards/.github/main/profile/assets/tkb-organization-hero.svg" width="100%" alt="Team Killing Bastards — Scottish gaming community and technical project organisation">
...
<td width="25%" align="center"><strong>⚙️ FOUR ORG SYSTEMS</strong><br><sub>Public products and private operational platforms.</sub></td>
...
flowchart LR
    ...
    MartySpace --> MartyRepos[Marty repositories]

    TKBRepos --> Routing[Repository-specific Discord routing]
    ConroyRepos --> Routing
    MartyRepos --> Routing
